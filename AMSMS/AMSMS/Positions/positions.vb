Public Class positions
    ...
    Public Property position As String          'store position when click
    Public Property rate As Double              'store rate of the position
    ...
    Private Sub dgvData_Click(sender As Object, e As EventArgs) Handles dgvData.Click
        ...
        Else
            If dgvData.SelectedRows.Count > 0 Then
                ...
                position = dgvData.CurrentRow.Cells(1).Value
                rate = dgvData.CurrentRow.Cells(2).Value
            End If
        End If
    End Sub

    Private Sub positions_LocationChanged(sender As Object, e As EventArgs) Handles Me.LocationChanged
        Me.CenterToScreen()
    End Sub
    ...
    Public Sub loads()
        q.positionsLoadDgv(dgvData, txtFilter.Text)
