Public Class admin
    ...
    Public Property username As String          'store username when click
    ...
    Private Sub dgvData_Click(sender As Object, e As EventArgs) Handles dgvData.Click
        ...
        Else
            If dgvData.SelectedRows.Count > 0 Then
                ...
                username = dgvData.CurrentRow.Cells(1).Value
            End If
        End If
    End Sub

    Private Sub adminMainform_LocationChanged(sender As Object, e As EventArgs) Handles Me.LocationChanged
        Me.CenterToScreen()
    End Sub
    ...
    'load dgv
    Public Sub loads()
        q.adminLoadAccounts(dgvData, txtFilter.Text)
